...
namespace BMSCSupplierRegistration.WPRegistrationForm
{
    ...
    public class WPRegistrationForm : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/BMSCSupplierRegistration/WPRegistrationForm/WPRegistrationFormUserControl.ascx";
